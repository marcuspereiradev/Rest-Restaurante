  ...
  var $defaults;
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Prasoon: Services 3 Column Section', 'prasoon' ), // Name
			array( 'description' => __( 'Adds Services section. Section id : services', 'prasoon' ), ) // Args
		);
    ...
    ?>
    <section id="services" style="background:<?php echo $color; ?>;">
